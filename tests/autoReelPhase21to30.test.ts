...
import { createAutoReelJob, AutoReelJob } from '../src/features/auto-reel/models';
import { runProductionDirector } from '../src/features/auto-reel/productionPipeline';
import { runCinematographer } from '../src/features/auto-reel/cinematographyPipeline';
import { runVFXDirector } from '../src/features/auto-reel/vfxPipeline';
import { runSoundDesigner } from '../src/features/auto-reel/soundDesignPipeline';
import { runHollywoodDirector } from '../src/features/auto-reel/hollywoodPipeline';
import { runCameraDirector } from '../src/features/auto-reel/cameraDirectorPipeline';
import { runPsychologyEngine } from '../src/features/auto-reel/psychologyPipeline';
import { runViralReelDirector } from '../src/features/auto-reel/viralReelPipeline';
import { ProjectReviewService } from '../src/features/auto-reel/collaborationService';
import { PluginManager } from '../src/features/auto-reel/marketplaceService';
...
describe('RK Flow 3.0: Batches 21-30 Final Intelligence Pipeline', () => {
    ...
    it('should successfully run Production Director analysis', async () => {
        const job = createAutoReelJob({} as any, 'job-21');
    ...
    it('should successfully run Cinematography analysis', async () => {
        const job = createAutoReelJob({} as any, 'job-22');
    ...
    it('should successfully run VFX Director', async () => {
        const job = createAutoReelJob({} as any, 'job-23');
    ...
    it('should successfully run Sound Designer', async () => {
        const job = createAutoReelJob({} as any, 'job-24');
    ...
    it('should successfully run Hollywood Director Review', async () => {
        const job = createAutoReelJob({} as any, 'job-25');
    ...
    it('should successfully run Camera Director', async () => {
        const job = createAutoReelJob({} as any, 'job-26');
    ...
    it('should successfully run Story Psychology Engine', async () => {
        const job = createAutoReelJob({} as any, 'job-27');
    ...
    it('should successfully run Viral Reel Director', async () => {
        const job = createAutoReelJob({} as any, 'job-28');
    ...
    it('should successfully instantiate Collaboration Service', async () => {
        const job = createAutoReelJob({} as any, 'job-29');
